...
parser.add_argument('--outf', default='./heritage_f_model_distilltion_model/', help='folder to output images and model checkpoints')
...
trainset = torchvision.datasets.DatasetFolder(root='./pkl_train_heritage_f_model_distilltion_model', loader=pkl_loader, extensions=(".pkl",))
...
if __name__ == "__main__":
    ...
    with open("acc_heritage_f_model_distilltion_model.txt", "w") as f:
        with open("log_heritage_f_model_distilltion_model.txt", "w")as f2:
            for epoch in range(pre_epoch, EPOCH):
                ...
                with torch.no_grad():
                    ...
                    # record test acc
                    if acc > best_acc:
                        f3 = open("best_acc_heritage_f_model_distilltion_model.txt", "w")
