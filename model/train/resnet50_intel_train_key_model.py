...
parser.add_argument('--outf', default='./intel_key_model/', help='folder to output images and model checkpoints')
...
if __name__ == "__main__":
    ...
    with open("acc_intel_key_model.txt", "w") as f:
        with open("log_intel_key_model.txt", "w")as f2:
            for epoch in range(pre_epoch, EPOCH):
                ...
                with torch.no_grad():
                    ...
                    # record test acc
                    if acc > best_acc:
                        f3 = open("best_acc_intel_key_model.txt", "w")
